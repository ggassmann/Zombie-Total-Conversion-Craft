...
public class ItemWeapon extends Item implements IItemRenderer {
    ...
    public static ItemWeapon venusSMP = new ItemWeapon("Venus SMP", FireMechanism.automatic, 0.48, 3.9, 25, 200, 17, 2).barrelLength(2.0f).sightHeight(0.3f).damage(3);
    public static ItemWeapon fDRbine = new ItemWeapon("FDRbine", FireMechanism.burst3slow, 0.45, 6, 9, 72, 20, 4).barrelLength(2.0f).sightHeight(1.0f).damage(2);
